(function() {
    ...
    var helloMessage = sayHello('Jeremy');
    ...
    totalBill = prompt('What is the bill total?');
    percentage = prompt ('What percentage would you like to tip? (use a decimal)');
    alert ('You should tip $' + (totalBill * percentage) + '.');
